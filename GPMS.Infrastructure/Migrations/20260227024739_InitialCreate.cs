        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 1m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupID = table.Column<int>(type: "int", nullable: false),
                    TotalScore = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Draft"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ADMIN001", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4329), "admin@fpt.edu.vn", "System Admin", null, "admin" },
                    { "GV001", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4340), "giao-vien1@fpt.edu.vn", "Lecturer One", null, null },
                    { "GV002", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4343), "giao-vien2@fpt.edu.vn", "Lecturer Two", null, null },
                    { "GV003", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4344), "giao-vien3@fpt.edu.vn", "Lecturer Three", null, null },
                    { "SE180001", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4346), "student1@fpt.edu.vn", "Student One", null, null },
                    { "SE180002", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4348), "student2@fpt.edu.vn", "Student Two", null, null },
                    { "SE180003", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4349), "student3@fpt.edu.vn", "Student Three", null, null },
                    { "SE180004", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4377), "student4@fpt.edu.vn", "Student Four", null, null },
                    { "SE180005", null, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4379), "student5@fpt.edu.vn", "Student Five", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4401), "Admin", "ADMIN001" },
                    { 2, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4402), "Lecturer", "GV001" },
                    { 3, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4403), "Lecturer", "GV002" },
                    { 4, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4404), "Lecturer", "GV003" },
                    { 5, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4405), "Student", "SE180001" },
                    { 6, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4405), "Student", "SE180002" },
                    { 7, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4406), "Student", "SE180003" },
                    { 8, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4407), "Student", "SE180004" },
                    { 9, new DateTime(2026, 2, 27, 2, 47, 38, 572, DateTimeKind.Utc).AddTicks(4408), "Student", "SE180005" }
                });
